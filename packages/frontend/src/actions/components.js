...
export const postComponent = ({name, type, description, status}, callbacks = {}) => {
  return async dispatch => {
    try {
      const body = { name, type, description, status }
...
export const updateComponent = ({componentID, name, type, description, status, order}, callbacks = {}) => {
  return async dispatch => {
    try {
      const body = { name, type, description, status, order }
